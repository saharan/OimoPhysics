...
class Mat4 {
	 ...
	 */
	public inline function addEqual(m:Mat4):Mat4 {
		return initi(
			e00 + m.e00, e01 + m.e01, e02 + m.e02, e03 + m.e03,
			e10 + m.e10, e11 + m.e11, e12 + m.e12, e13 + m.e13,
			e20 + m.e20, e21 + m.e21, e22 + m.e22, e23 + m.e23,
	 ...
	 * Sets this matrix to `this` - `m` and returns `this`.
	 */
	public inline function subEqual(m:Mat4):Mat4 {
		return initi(
			e00 - m.e00, e01 - m.e01, e02 - m.e02, e03 - m.e03,
			e10 - m.e10, e11 - m.e11, e12 - m.e12, e13 - m.e13,
			e20 - m.e20, e21 - m.e21, e22 - m.e22, e23 - m.e23,
	 ...
	 */
	public inline function scaleEqual(s:Float):Mat4 {
		return initi(
			e00 * s, e01 * s, e02 * s, e03 * s,
			e10 * s, e11 * s, e12 * s, e13 * s,
			e20 * s, e21 * s, e22 * s, e23 * s,
	 ...
	 * Sets this matrix to `this` * `m` and returns `this`.
	 */
	public inline function mulEqual(m:Mat4):Mat4 {
		return initi(
			e00 * m.e00 + e01 * m.e10 + e02 * m.e20 + e03 * m.e30,
			e00 * m.e01 + e01 * m.e11 + e02 * m.e21 + e03 * m.e31,
			e00 * m.e02 + e01 * m.e12 + e02 * m.e22 + e03 * m.e32,
	 ...
	 * `sz` times along the x-axis, y-axis and z-axis respectively.
	 */
	public inline function prependScaleEqual(sx:Float, sy:Float, sz:Float):Mat4 {
		return initi(
			e00 * sx, e01 * sx, e02 * sx, e03 * sx,
			e10 * sy, e11 * sy, e12 * sy, e13 * sy,
			e20 * sz, e21 * sz, e22 * sz, e23 * sz,
	 ...
	 * `sz` times along the x-axis, y-axis and z-axis respectively.
	 */
	public inline function appendScaleEqual(sx:Float, sy:Float, sz:Float):Mat4 {
		return initi(
			e00 * sx, e01 * sy, e02 * sz, e03,
			e10 * sx, e11 * sy, e12 * sz, e13,
			e20 * sx, e21 * sy, e22 * sz, e23,
	 ...
	 * vector (`axisX`, `axisY`, `axisZ`).
	 */
	public inline function prependRotationEqual(rad:Float, axisX:Float, axisY:Float, axisZ:Float):Mat4 {
		var s:Float = MathUtil.sin(rad);
		var c:Float = MathUtil.cos(rad);
		var c1:Float = 1 - c;
		var r00:Float = axisX * axisX * c1 + c;
	 ...
	 * vector (`axisX`, `axisY`, `axisZ`).
	 */
	public inline function appendRotationEqual(rad:Float, axisX:Float, axisY:Float, axisZ:Float):Mat4 {
		var s:Float = MathUtil.sin(rad);
		var c:Float = MathUtil.cos(rad);
		var c1:Float = 1 - c;
		var r00:Float = axisX * axisX * c1 + c;
	 ...
	 * the x-axis, y-axis and z-axis respectively.
	 */
	public inline function prependTranslationEqual(tx:Float, ty:Float, tz:Float):Mat4 {
		return initi(
			e00 + tx * e30, e01 + tx * e31, e02 + tx * e32, e03 + tx * e33,
			e10 + ty * e30, e11 + ty * e31, e12 + ty * e32, e13 + ty * e33,
			e20 + tz * e30, e21 + tz * e31, e22 + tz * e32, e23 + tz * e33,
	 ...
	 * the x-axis, y-axis and z-axis respectively.
	 */
	public inline function appendTranslationEqual(tx:Float, ty:Float, tz:Float):Mat4 {
		return initi(
			e00, e01, e02, e00 * tx + e01 * ty + e02 * tz + e03,
			e10, e11, e12, e10 * tx + e11 * ty + e12 * tz + e13,
			e20, e21, e22, e20 * tx + e21 * ty + e22 * tz + e23,
	 ...
	 */
	public inline function transposeEqual():Mat4 {
		return initi(
			e00, e10, e20, e30,
			e01, e11, e21, e31,
			e02, e12, e22, e32,
	 ...
	 */
	public inline function invertEqual():Mat4 {
		var d01_01:Float = e00 * e11 - e01 * e10;
		var d01_02:Float = e00 * e12 - e02 * e10;
		var d01_03:Float = e00 * e13 - e03 * e10;
		var d01_12:Float = e01 * e12 - e02 * e11;
	 ...
	 * projection transformation with field of view in y direction `fovY` in radians,
	...
	public function toString():String {
		return
			"[" + M.toFixed4(e00) + ", " + M.toFixed4(e01) + ", " + M.toFixed4(e02) + ", " + M.toFixed4(e03) + ";\n" +
			" " + M.toFixed4(e10) + ", " + M.toFixed4(e11) + ", " + M.toFixed4(e12) + ", " + M.toFixed4(e13) + ";\n" +
			" " + M.toFixed4(e20) + ", " + M.toFixed4(e21) + ", " + M.toFixed4(e22) + ", " + M.toFixed4(e23) + ";\n" +
			" " + M.toFixed4(e30) + ", " + M.toFixed4(e31) + ", " + M.toFixed4(e32) + ", " + M.toFixed4(e33) + "]"
		;
	}
